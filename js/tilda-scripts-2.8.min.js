...
Tilda.sendEventToStatistics(virtPage,virtTitle);if(url.substring(0,4)=='http'){window.setTimeout(function(){if(target=='_blank'){if($('#tildaredirectform').length==0){$('body').append('<form id="tildaredirectform" target="_blank" method="POST" action="'+url+'" style="display:none;"></form>')}else{$('#tildaredirectform').attr('action',url)}
